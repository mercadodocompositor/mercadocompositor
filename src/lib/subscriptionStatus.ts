...
export const SUBSCRIPTION_STATUS_META: Record<SubscriptionStatus, SubscriptionStatusMeta> = {
  ...
  pending: {
    ...
    description: 'Você ainda não escolheu um plano. Nenhuma assinatura ou cobrança está ativa.',
    nextStep: 'Escolha um plano e comece com 7 dias grátis para publicar suas músicas.',
  ...
  suspended: {
    ...
    nextStep: 'Atualize a forma de pagamento na aba Assinatura para restaurar a visibilidade.',
  ...
  cancelled: {
    ...
    nextStep: 'Assine um plano na aba Assinatura para voltar a publicar o catálogo.',
